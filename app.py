...
#fonction pour la saisi utilisateur
def saisi():
    ...
    try:
        response = client.responses.create(
            ...
            instructions= "Tu es un assistant répondant UNIQUEMENT à des questions sur les CGV de MonEshop. Si la réponse ne figure pas dans tes données fine-tunées, réponds : 'Je ne sais pas.'",
            input= question
        )
